...
: ${AMENT_CURRENT_PREFIX:="/home/hisham/brokk_ws/install/brokk_tracked_test"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/brokk_tracked_test/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/brokk_tracked_test/environment/path.sh"
